...
import { BookOpen, TrendingUp, Menu, X, PieChart, Globe, CandlestickChart, Bitcoin, CreditCard, ShieldCheck, Search, NotebookText, Settings, FlaskConical, LayoutDashboard, Wrench } from "lucide-react";
...
export default function Layout({ children }: { children: React.ReactNode }) {
  ...
  const advancedItems = [
    { href: "/opportunities", icon: Search, label: "Signals" },
    { href: "/execution", icon: Wrench, label: "Execution" },
    { href: "/trade-desk", icon: CandlestickChart, label: "Trade Desk" },
    { href: "/simulations", icon: FlaskConical, label: "Simulations" },
    { href: "/intelligence", icon: ShieldCheck, label: "Intelligence" },
    { href: "/reports", icon: NotebookText, label: "Reports" },
  ];
      ...
      <div className="flex flex-1 overflow-hidden">
        ...
        <aside className="hidden md:flex flex-col w-64 border-r border-border bg-card/30 backdrop-blur-xl">
          ...
          <nav className="flex-1 p-4 space-y-6 overflow-y-auto">
            ...
            <div className="space-y-2">
              <p className="px-4 text-xs font-semibold text-muted-foreground uppercase tracking-wider">Advanced</p>

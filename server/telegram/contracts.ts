...
export type TelegramEnvironmentConfig = {
  ...
  transport: "disabled" | "long_polling" | "webhook";
...
export type TelegramMetricsSnapshot = {
  ...
  pollingConflicts: number;
  lastCommandPollerStartDecision: Record<string, unknown> | null;
  lastCommandReceivedAt: string | null;
  lastCommandProcessedAt: string | null;

...
function setEnv(values: Record<string, string>) {
  process.env = { ...originalEnv, DATABASE_URL: undefined, FINCOACH_WEEKLY_RESEARCH_SCHEDULE_ENABLED: "true", FINCOACH_WEEKLY_RESEARCH_TIMEZONE: "America/New_York", ...values };
}

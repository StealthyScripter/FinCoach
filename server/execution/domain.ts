...
export const INSTRUMENTS: Instrument[] = [
  ...
  instrument("AUD/USD", "forex", "AUD", "USD", 0.0001, 0.00001, 100_000, 0.0333, { oanda: "AUD_USD", metatrader5: "AUDUSD", tradingview: "OANDA:AUDUSD" }),
  instrument("NZD/USD", "forex", "NZD", "USD", 0.0001, 0.00001, 100_000, 0.0333, { oanda: "NZD_USD", metatrader5: "NZDUSD", tradingview: "OANDA:NZDUSD" }),
  instrument("USD/JPY", "forex", "USD", "JPY", 0.01, 0.001, 100_000, 0.0333, { oanda: "USD_JPY", metatrader5: "USDJPY", tradingview: "OANDA:USDJPY" }),
  instrument("USD/CHF", "forex", "USD", "CHF", 0.0001, 0.00001, 100_000, 0.0333, { oanda: "USD_CHF", metatrader5: "USDCHF", tradingview: "OANDA:USDCHF" }),
  instrument("USD/CAD", "forex", "USD", "CAD", 0.0001, 0.00001, 100_000, 0.0333, { oanda: "USD_CAD", metatrader5: "USDCAD", tradingview: "OANDA:USDCAD" }),
  instrument("EUR/JPY", "forex", "EUR", "JPY", 0.01, 0.001, 100_000, 0.0333, { oanda: "EUR_JPY", metatrader5: "EURJPY", tradingview: "OANDA:EURJPY" }),
  instrument("GBP/JPY", "forex", "GBP", "JPY", 0.01, 0.001, 100_000, 0.0333, { oanda: "GBP_JPY", metatrader5: "GBPJPY", tradingview: "OANDA:GBPJPY" }),
  instrument("AUD/JPY", "forex", "AUD", "JPY", 0.01, 0.001, 100_000, 0.0333, { oanda: "AUD_JPY", metatrader5: "AUDJPY", tradingview: "OANDA:AUDJPY" }),
  instrument("NZD/JPY", "forex", "NZD", "JPY", 0.01, 0.001, 100_000, 0.0333, { oanda: "NZD_JPY", metatrader5: "NZDJPY", tradingview: "OANDA:NZDJPY" }),
  instrument("CAD/JPY", "forex", "CAD", "JPY", 0.01, 0.001, 100_000, 0.0333, { oanda: "CAD_JPY", metatrader5: "CADJPY", tradingview: "OANDA:CADJPY" }),
  instrument("CHF/JPY", "forex", "CHF", "JPY", 0.01, 0.001, 100_000, 0.0333, { oanda: "CHF_JPY", metatrader5: "CHFJPY", tradingview: "OANDA:CHFJPY" }),
  instrument("EUR/GBP", "forex", "EUR", "GBP", 0.0001, 0.00001, 100_000, 0.0333, { oanda: "EUR_GBP", metatrader5: "EURGBP", tradingview: "OANDA:EURGBP" }),
  instrument("EUR/CHF", "forex", "EUR", "CHF", 0.0001, 0.00001, 100_000, 0.0333, { oanda: "EUR_CHF", metatrader5: "EURCHF", tradingview: "OANDA:EURCHF" }),
  instrument("EUR/AUD", "forex", "EUR", "AUD", 0.0001, 0.00001, 100_000, 0.0333, { oanda: "EUR_AUD", metatrader5: "EURAUD", tradingview: "OANDA:EURAUD" }),
  instrument("EUR/NZD", "forex", "EUR", "NZD", 0.0001, 0.00001, 100_000, 0.0333, { oanda: "EUR_NZD", metatrader5: "EURNZD", tradingview: "OANDA:EURNZD" }),
  instrument("EUR/CAD", "forex", "EUR", "CAD", 0.0001, 0.00001, 100_000, 0.0333, { oanda: "EUR_CAD", metatrader5: "EURCAD", tradingview: "OANDA:EURCAD" }),
  instrument("GBP/CHF", "forex", "GBP", "CHF", 0.0001, 0.00001, 100_000, 0.0333, { oanda: "GBP_CHF", metatrader5: "GBPCHF", tradingview: "OANDA:GBPCHF" }),
  instrument("GBP/AUD", "forex", "GBP", "AUD", 0.0001, 0.00001, 100_000, 0.0333, { oanda: "GBP_AUD", metatrader5: "GBPAUD", tradingview: "OANDA:GBPAUD" }),
  instrument("GBP/NZD", "forex", "GBP", "NZD", 0.0001, 0.00001, 100_000, 0.0333, { oanda: "GBP_NZD", metatrader5: "GBPNZD", tradingview: "OANDA:GBPNZD" }),
  instrument("GBP/CAD", "forex", "GBP", "CAD", 0.0001, 0.00001, 100_000, 0.0333, { oanda: "GBP_CAD", metatrader5: "GBPCAD", tradingview: "OANDA:GBPCAD" }),
  instrument("AUD/NZD", "forex", "AUD", "NZD", 0.0001, 0.00001, 100_000, 0.0333, { oanda: "AUD_NZD", metatrader5: "AUDNZD", tradingview: "OANDA:AUDNZD" }),
  instrument("AUD/CAD", "forex", "AUD", "CAD", 0.0001, 0.00001, 100_000, 0.0333, { oanda: "AUD_CAD", metatrader5: "AUDCAD", tradingview: "OANDA:AUDCAD" }),
  instrument("AUD/CHF", "forex", "AUD", "CHF", 0.0001, 0.00001, 100_000, 0.0333, { oanda: "AUD_CHF", metatrader5: "AUDCHF", tradingview: "OANDA:AUDCHF" }),
  instrument("NZD/CAD", "forex", "NZD", "CAD", 0.0001, 0.00001, 100_000, 0.0333, { oanda: "NZD_CAD", metatrader5: "NZDCAD", tradingview: "OANDA:NZDCAD" }),

...
export const STRATEGY_TEMPLATES: StrategyTemplate[] = [
  ...
  template("breakout.session_high_low_breakout", "Session-high-low breakout", "breakout", ["session_range"], ["breakout"], ["structure.breakOfStructure"], ["session_range_high_low", "opening_range"], ["volatility_expansion"], ["tokyo", "london_morning", "new_york_open"], ["5m", "15m", "30m"], [{ variantId: "atr_1_25_to_2r", stopLoss: atr(1.25), takeProfit: atr(2), timeExit: time("2h") }]),

...
export const STRATEGY_TEMPLATES: StrategyTemplate[] = [
  ...
  template("breakout.volatility_compression_breakout", "Volatility-compression breakout", "breakout", ["compression", "expansion"], ["volatility-compression", "breakout"], ["volatility.compression", "structure.breakOfStructure"], ["atr", "realized_volatility", "compression_ratio"], ["volatility_compression", "volatility_expansion"], ["fx"], ["15m", "30m", "1h"], [{ variantId: "atr_1_5_to_2r", stopLoss: atr(1.5), takeProfit: atr(2), timeExit: time("2h") }, { variantId: "atr_2_to_3r", stopLoss: atr(2), takeProfit: atr(3), timeExit: time("4h") }]),

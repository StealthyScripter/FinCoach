...
export const persistenceInventory: readonly PersistenceRequirement[] = [
  ...
  req("forward-testing", "forward_test", "durable_recommended", "forwardTestId", "forwardTestId", "append_only", "retain strategy evidence lifetime", "preserve approved demo forward test evidence", ["by strategy", "by status"], "fincoach.v2.forward-test.1", "module-owned forward test table", "future"),
  req("signals", "research_signal", "durable_recommended", "signalId", "signalId", "append_only", "retain signal evidence lifetime", "preserve research-only signal and duplicate prevention", ["by symbol", "by forward test"], "fincoach.signal.v2", "module-owned signal table", "future"),
  req("external-evaluation", "external_evaluation", "durable_recommended", "evaluationId", "evaluationId", "append_only", "retain evidence lifetime", "preserve independent evaluator outcomes", ["by signal", "by outcome"], "fincoach.v2.external-evaluation.1", "module-owned evaluation table", "future"),
  req("journal", "research_journal_entry", "durable_recommended", "journalEntryId", "journalEntryId", "append_only", "retain indefinitely", "preserve institutional research evidence", ["by subject", "by createdAt"], "fincoach.v2.research-journal.1", "append-only journal table", "future"),
  req("learning", "lesson", "durable_recommended", "lessonId", "lessonId", "append_only", "retain evidence lifetime", "preserve lessons and supersession", ["by topic", "by evidence"], "fincoach.v2.learning-lesson.1", "module-owned lessons table", "future"),
  req("strategy-lifecycle", "lifecycle_decision", "durable_recommended", "decisionId", "decisionId", "append_only", "retain strategy lifetime", "preserve promotion/pause/degrade/retire history", ["by strategy", "by state"], "fincoach.v2.strategy-lifecycle.1", "append-only lifecycle table", "future"),
  req("strategy-evolution", "strategy_revision", "durable_recommended", "proposalId", "proposalId", "append_only", "retain strategy lifetime", "preserve parent-child lineage", ["by parent", "by child"], "fincoach.v2.strategy-revision.1", "module-owned revision table", "future"),
  req("courtroom", "court_verdict", "durable_recommended", "courtCaseId", "courtCaseId", "append_only", "retain strategy evidence lifetime", "preserve courtroom challenge evidence", ["by strategy", "by verdict"], "fincoach.v2.courtroom.1", "module-owned court table", "future"),
  req("ranking", "ranking_decision", "durable_recommended", "rankingId", "rankingId", "append_only", "retain portfolio evidence lifetime", "preserve candidate ranking and selection", ["by strategy", "latest ranking"], "fincoach.v2.ranking.1", "module-owned ranking table", "future"),

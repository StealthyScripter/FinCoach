...
env -u DATABASE_URL -u TEST_DATABASE_URL \
  -u FINCOACH_TELEGRAM_BOT_TOKEN -u FINCOACH_TELEGRAM_ALLOWED_USER_ID -u FINCOACH_TELEGRAM_CHAT_ID -u FINCOACH_TELEGRAM_SIGNAL_CHAT_ID \
  -u FINCOACH_TELEGRAM_WEBHOOK_SECRET -u FINCOACH_TELEGRAM_WEBHOOK_URL \
